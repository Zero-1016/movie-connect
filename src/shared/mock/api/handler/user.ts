...
import type { MyBookMarkResponse, MyReviewResponse } from '@/shared/api/model'
import { MyLikeMovie } from '@/shared/api/model/movie-info'
import { generateProfileContent } from '@/shared/mock/construct/generate-profile-content'
