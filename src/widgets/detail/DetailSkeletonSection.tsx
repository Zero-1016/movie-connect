...
import middle_styles from "@/widgets/detail/detail-middle-section.module.scss";
import top_styles from "@/widgets/detail/detail-top-section.module.scss";

export function DetailSkeletonSection() {
    useBlockScroll()
    return <>
        ...
        <section className={middle_styles.container}>
            <div className={middle_styles.leftSection}>
                <Skeleton variant="rectangular" width={480} height={720}
                          sx={{ borderRadius: "24px", height: '100%', backgroundColor: 'rgba(255,255,255, 30%)' }}/>
            </div>
            <div className={classNames(middle_styles.rightSection, poppins.className)}>
                ...
                <span className={middle_styles.description}><Skeleton width={540} variant="rectangular" height={720}
                                                                      sx={{ width: '100%', backgroundColor: 'rgba(255,255,255, 30%)' }}/></span>
                <div className={middle_styles.averageBox}>
                </div>
